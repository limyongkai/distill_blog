...
# Continue Investigation from [Part 2](https://limyongkai.netlify.app/posts/2021-07-23-vastmc2part1/)....
...
```{r, echo=FALSE}
save(cc,gps,car,gps_stop,final_trans_1,gps_sf, file="part2data.RData")
```
