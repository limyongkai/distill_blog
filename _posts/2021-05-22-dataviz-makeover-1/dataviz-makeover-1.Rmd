...
```{r original-visualisation, fig.align = 'center', fig.cap = 'Original Visualisation', echo=FALSE}
...
6. Different axis intervals and range giving the wrong visual perception:
    ...
    + Inter-plot y-axis intervals and range for import and exports are different. 
    + Y-axis label is confusing. The "M" was not explained.
7. Merchandise trade can be seasonsal and it fluctuates heavily by month. A condensed time frame might be more useful for the visualiation. 
...
```{r sketch, fig.align = 'center', fig.cap = 'Sketch of alternative visualisation', echo=FALSE}
...
```{r import-step1, fig.align = 'center', fig.cap = 'Load the Import worksheet', echo=FALSE}
...
```{r import-step2, fig.align = 'center', fig.cap = 'Exclude the rows for regions', echo=FALSE}
...
```{r import-step3, fig.align = 'center', fig.cap = 'Pivot Date into row', echo=FALSE}
...
```{r import-step4, fig.align = 'center', fig.cap = 'Clean column header and label data type', echo=FALSE}
...
```{r import-step5, fig.align = 'center', fig.cap = 'Join both tables', echo=FALSE}
...
2. Add two *Applied Join Clauses* to match *Date* and *Country* shown in <span style="color:orange">orange box</span>. <br />
3. Select the *Join Type* to *full* in the <span style="color:green">green box</span>. <br />
...
```{r import-step6, fig.align = 'center', fig.cap = 'Create new column for total sum of export and import', echo=FALSE}
...
```{r import-step7, fig.align = 'center', fig.cap = 'Pivot the Export, Import and Total columns', echo=FALSE}
...
```{r import-step8, fig.align = 'center', fig.cap = 'Output into csv', echo=FALSE}
...
```{r viz-step1, fig.align='center', fig.cap='Filter the Country and Year', echo=FALSE}
...
```{r viz-lineplot-1, fig.align='center', fig.cap='Dual axis and sychronize of dual y-axis', echo=FALSE}
...
6. Right click the the secondary dual y-axis on the right and uncheck the *Show Header* option to remove the y-axis. As the secondary y-axis is of the same interval as the primary y-axis on the left, there is no value is displaying it.
7. Rename the y-axis to *Trade Value (S$)*.
8. Change the Title of the graph to *Merchandise Trade of Top Six Trading Countries with Singapore from 2019 to 2020, (S$)*.
9. Annotate increase or decrease of total trade in percentage as shown in Figure \@ref(fig:viz-lineplot-2).
9. Annotate unique insights on the graph as shown in Figure \@ref(fig:viz-lineplot-2). For example, indicating strong increase or decrease of the import or export on the graph.

```{r viz-lineplot-2, fig.align = 'center', fig.cap = 'Final Line Plot', echo=FALSE}
...
```{r viz-barchart-1, fig.align = 'center', fig.cap = 'Create new Variable for other countries', echo=FALSE}
...
```{r viz-barchart-2, fig.align = 'center', fig.cap = 'Final Bar Chart (2020)', echo=FALSE}
...
```{r viz-dashboard-1, fig.align = 'center', fig.cap = 'Dashboard wireframe', echo=FALSE}
...
```{r viz-dashboard-2, fig.align = 'center', fig.cap = 'Final Dashboard', echo=FALSE}
